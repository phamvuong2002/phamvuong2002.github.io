...
function createResponedDisplay(data){
    ...
    //
    let hoahong = parseFloat(sum_money * 0.2).toFixed(2).toString();
    const labelhh = document.createElement('label')
    labelhh.appendChild(document.createTextNode(hoahong))
    footer[2].appendChild(labelhh)
    //
